...
for idx = 1:length(tout)
    ...
    %%%Then we make our 4 function calls for the RK4(Runge Kutta4)
...
%%%This project was recreated from Dr. Carlos Montalvo's (University of South Alabama) Github repo and
%%%Youtube series for the purpose of simulating UNLV's RebelSat-1 detumble
%%%time.
